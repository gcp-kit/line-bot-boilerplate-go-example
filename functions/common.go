...
func TextEvent(_ context.Context, op *cmd.Operation, event *linebot.Event) *cmd.TracerResp {
...
func LocationEvent(_ context.Context, _ *cmd.Operation, event *linebot.Event) *cmd.TracerResp {
	resp := new(cmd.TracerResp)
...
func FollowEvent(_ context.Context, op *cmd.Operation, event *linebot.Event) *cmd.TracerResp {
	resp := new(cmd.TracerResp)
...
func UnfollowEvent(_ context.Context, _ *cmd.Operation, event *linebot.Event) *cmd.TracerResp {
	resp := new(cmd.TracerResp)
	name := util.GetCallFuncName()
	log.Println("Call:", name)
